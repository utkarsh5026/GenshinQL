 ...
 * @param {number[]} props.selectedRarities - Array of selected rarity values (1-5)
 * @param {Function} props.onToggleRarity - Callback to toggle rarity filter
 * @param {Function} props.onClearAll - Callback to clear all filters
 * @returns {JSX.Element} Filter bar with search and rarity controls
 */
